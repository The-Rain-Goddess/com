...
public class Dreadnaught extends Ship{
	...
	private final String SHIP_TYPE = "DREADNAUGHT";
	//combat stats
...
//public constructor
	public Dreadnaught(String name, Direction pos, Direction vel, Direction acc){
		...
		//combat stats
		this.FIRE_POWER = 900.0/100;
		this.TOTAL_HP = 10000.0;
		this.TOTAL_SHIELD = 4000.0;
